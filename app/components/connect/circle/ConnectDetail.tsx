...
const ConnectDetail = () => {
    return (
        <Container>
            <div className="w-[569px] flex flex-col gap-14">
                <div className="flex flex-col gap-4 lg:pt-0 pt-10">
                    <h1 className="lg:text-4xl text-2xl font-light">
                        Connect and <br/> collaborate with our <br/> <span
                        className="font-bold">Communication Tools</span>
                    </h1>
                    <p className="font-bold lg:text-lg text-sm">
                        From instant messaging to video calls, our tools <br/> empower you to build bridges and create
                        magic, no <br/> matter where you are.
                    </p>
                </div>
