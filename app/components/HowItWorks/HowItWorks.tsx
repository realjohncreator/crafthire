    ...
    return (
        <Container>
            <div className="md:pt-14 py-6 flex flex-col items-center gap-8 justify-center">
                <h1 className="lg:text-6xl text-4xl font-bold">How it Works</h1>
                <Image src={WorkImage} alt="work image"/>

                <div className="grid grid-cols-1 md:grid-cols-3 md:gap-52 gap-10">
                    <div className="flex flex-col gap-4">
                        <h1 className="font-bold text-lg">Sign Up and fill the requirements</h1>
                    ...
                    <div className="flex flex-col gap-4">
                        <h1 className="font-bold text-lg">Talk with a project manager</h1>
                        <p className="font-light">
                    ...
                    <div className="flex flex-col gap-4">
                        <h1 className="font-bold text-lg">Pick a team and start your project</h1>
                        <p className="font-light">
